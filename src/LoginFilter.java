...
//        }
    ...
    public void init(FilterConfig fConfig) {
        ...
        allowedURIs.add("/autocomplete/autocomplete.js");
        allowedURIs.add("/api/hero-suggestion");
	allowedURIs.add("/api/search-results");
	allowedURIs.add("autocomplete-styles.css");
