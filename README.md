...
| Case 2: HTTP/10 threads                        | ![/img/case-6.png](/img/case-6.png)   | 266                         | 13.189380360321145                                  | 11.468891909266782                        | There is almost no increase in avg query time here because the load balancing offsets the jump in users by always choosing the most ideal instance to handle the requests quickly.           |
